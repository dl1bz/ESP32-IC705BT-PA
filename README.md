...
In the meantime many things around the ESP32 were changed, I can no longer say for sure whether this project needs a code revision.<br>
However, I will not revise this project any more.
